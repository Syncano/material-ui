...
var LinkMenuItem = React.createClass({
  ...
  render: function render() {
    ...
    var linkStyles = this.mergeAndPrefix(styles.root, this.props.style, this.props.selected && styles.rootWhenSelected, this.props.active && !this.props.disabled && styles.rootWhenHovered, this.props.disabled && styles.rootWhenDisabled);

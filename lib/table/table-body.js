      ...
      (function () {
        ...
        React.Children.forEach(_this.props.children, function (child) {
          if (React.isValidElement(child)) {
            if (child.props.selected && (preSelectedRows.length === 0 || _this.props.multiSelectable)) {
      ...
      if (React.isValidElement(child)) {
        var _ret2 = (function () {
          var props = {
            ...
            selected: _this2._isRowSelected(rowNumber),
            striped: _this2.props.stripedRows && rowNumber % 2 === 0,
            rowNumber: rowNumber++
          };
          var checkboxColumn = _this2._createRowCheckboxColumn(props);

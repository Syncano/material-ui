...
var Table = React.createClass({
  ...
  render: function render() {
    ...
    var tableWrapperStyle = _props.tableWrapperStyle;
    var bodyTableStyle = _props.bodyTableStyle;

    var other = _objectWithoutProperties(_props, ['children', 'className', 'fixedFooter', 'fixedHeader', 'style', 'tableWrapperStyle', 'bodyTableStyle']);
    ...
    var mergedTableWrapperStyle = this.mergeAndPrefix(styles.tableWrapper, tableWrapperStyle);
    var mergedBodyTableStyle = this.mergeAndPrefix(styles.bodyTable, bodyTableStyle);
    ...
    return React.createElement(
      'div',
      { className: 'mui-table-wrapper', style: mergedTableWrapperStyle },
      headerTable,
      React.createElement(
        'div',
        { className: 'mui-body-table', style: mergedBodyTableStyle },
        React.createElement(
          'table',
